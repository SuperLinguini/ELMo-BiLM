...
class WikiText2Character(WikiText2):
    ...
    def batchify(self, vocab, batch_size, max_word_length=50):
        ...
        return vocab.dataset_to_char_ids(data[:sample_len*batch_size], batch_size, sample_len, max_word_length).swapaxes(0, 1)

    def bptt_batchify(self, vocab, seq_len, batch_size, last_batch='keep', load_path=None):
